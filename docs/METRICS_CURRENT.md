...
>
> **Last updated:** 2026-07-06 (negative-result archive evidence plumbing — v0.5.51)
> **New in v0.5.51:** `calibration-intake` now supports `--negative-archive` and can append inactive, toxic, and control-failure rows into `outputs/negative_result_archive.csv` via `reports/negative_archive.py`. This turns the prior archive template into executable evidence plumbing. 3 focused tests added.
