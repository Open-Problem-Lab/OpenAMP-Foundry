...
>
> **Last updated:** 2026-07-06 (external simulation adapter contract — v0.5.59)
> **New in v0.5.59:** `ExternalSimulationAdapter` protocol and `validate_external_adapter_result()` define a safe contract for third-party or heavyweight simulation integrations. No external simulator was added; this is an interface and guardrail change only.
